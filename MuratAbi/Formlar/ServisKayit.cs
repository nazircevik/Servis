    ...
    public partial class ServisKayit : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con = new SqlConnection(veri.Baglanti);
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = "Update Servis set Gelkm='"+servis.GelKm+"',Benzin='"+servis.Benzin+"',Sikayet='"+richTextBox1.Text+"',Iscilik="+servis.Iscilik+"where ServisKayitNumarasi="+Id+"";
